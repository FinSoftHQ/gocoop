      ...
      <div class="mx-auto max-w-screen-sm text-center">
        <div>
          ...
          <div class="flex justify-between mt-10">
            ...
            <!-- qrcode -->
              <FieldViewQrCode :modelValue="`link_your_website_here/officerapp/${data.id}/${pageId.page}`" class="w-[150px] h-[150px]" ></FieldViewQrCode>
          </div>
        </div>
        <div>
            <UButton icon="i-heroicons-arrow-path-solid"
            color="gray"
            variant="outline"
            @click="refreshQrCode">Refresh</UButton>
